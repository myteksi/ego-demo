...
# configure bazel_mockery
# see https://github.com/Helcaraxan/bazel_mockery
#
http_archive(
    name = "bazel_mockery",
    urls = [
        "https://github.com/Helcaraxan/bazel_mockery/archive/51bf6832ff56764ccf33411c55eb6bea883868fd.zip",
    ],
    sha256 = "41fef0d4f36a460aec43d8c7fada0cd54866bf59f5a2e1714d11c9302a7f4284",
    strip_prefix = "bazel_mockery-51bf6832ff56764ccf33411c55eb6bea883868fd",
    patches = ["gomockery.patch"],
    patch_args = ["-p1"],
)

load("@bazel_mockery//:gomockery.bzl", "go_mockery")
